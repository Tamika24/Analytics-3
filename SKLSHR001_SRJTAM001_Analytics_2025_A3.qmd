...
#| echo: false
#| label: fig-skew
#| caption: "Visual summary of the descriptive statistics of the data"

# Histogram with density for V1
ggplot(df, aes(x = df$V1)) +
  geom_histogram(aes(y = ..density..), bins = 30, fill = "skyblue", color = "black") +
  geom_density(color = "red", size = 1.2) +
  ggtitle("Distribution of V1") +
  xlab("V1") + ylab("Density")

# Histogram with density for V2
ggplot(df, aes(x = df$V2)) +
  geom_histogram(aes(y = ..density..), bins = 30, fill = "lightgreen", color = "black") +
  geom_density(color = "blue", size = 1.2) +
  ggtitle("Distribution of V2") +
  xlab("V2") + ylab("Density")
...
However, in both cases, the medians are near the respective means. Additionally, V1's IQR (`r iqr.v1`) is very similar to V2's IQR (`iqr.v2`). Together, these indicatie that the core of the distributions are roughly symmetric.
