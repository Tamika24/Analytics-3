...
The dataset contains 5000 observations of 2 numeric features (i.e. values are all integers) . There are no missing values in the data set. Variable 1 ranges from 89606 to 932954.
